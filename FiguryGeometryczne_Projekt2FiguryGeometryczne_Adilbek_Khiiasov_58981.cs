...
{
    public partial class FiguryGeometryczne_Projekt2FiguryGeometryczne_Adilbek_Khiiasov_58981 : Form
    {
        //deklaracje stałych
        ...
        /* deklaracja zmiennej referencyjnej (adresu) do egzemplarza powierzchni 
           ...
           identyfikatorze pbRysownica umieszczonej na formularzu*/
        Graphics Rysownica;
        ...
        public FiguryGeometryczne_Projekt2FiguryGeometryczne_Adilbek_Khiiasov_58981()
        {
            ...
            aktxtN.Location = new Point(aklabel1.Location.X + Margines,
                                        aklabel1.Location.Y + aklabel1.Height
                                                            + Margines);
            btnStart.Location = new Point(aktxtN.Location.X - Margines,
            ...
            chlbFiguryGeometryczne.Location = new Point(label2.Location.X,
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            {
                //sygnalizacja błędu
                errorProvider1.SetError(chlbFiguryGeometryczne,
            ...
            for (int i = 0; i < N; i++)
            {
                ...
                switch (WylosowanaFigura)
                {
                    ...
                    case "Wielokąt foremny":
                        ...
                        break;
                    default:
                        errorProvider1.SetError(btnStart, "ERROR: figura o nazwie: " +
        ...
        private void FiguryGeometryczne_Load(object sender, EventArgs e)
        {
            ...
            gbWybierzFigurę.Location = new Point(chlbFiguryGeometryczne.Location.X,
                                               chlbFiguryGeometryczne.Location.Y
                                               + chlbFiguryGeometryczne.Height + Margines / 2);
        }
            ...
            if (e.Button == MouseButtons.Left)
            {
                        ...
                        if (akbFillieElipsa.Checked)
                {
                    ...
                    Rysownica.FillEllipse(Pędzel, lewyGórnyNarożnikX, lewyGórnyNarożnikY,
                                       Szerokość, Wysokość);
                    //utworzenie egzemplarza klasy FillElipsa i dodanie jego referencji do listy LFG
